...
| `get_raid_state` | optional probe and reserve flags | Current base, all worker slots, empty and downed slot counts, live healthy Palbox reserves sorted by level, and the cached reinforcement queue/watchdog state. |
